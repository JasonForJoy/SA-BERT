...
class InputFeatures(object):
    ...
    def __init__(self, ques_ids, ans_ids, input_sents, input_mask, segment_ids, label_id):
        self.ques_ids = ques_ids
        self.ans_ids = ans_ids
...
def write_instance_to_example_files(instances, output_files):
    ...
    for (inst_index, instance) in enumerate(instances):
        ...
        # if inst_index < 5:
        # 	print("*** Example ***")
        # 	print("ques_ids: %s" % instance.ques_ids)
        # 	print("ans_ids: %s"  % instance.ans_ids)
